...
Set the applicable text to have a bold style. This class should be used to apply a bold styling to text.
If text is meant to convey "strong importance" (things of great seriousness or urgency - such as warnings) then wrap the applicable text in a ```<strong>``` tag instead of applying this class.
