...
interface CheckboxProps {
  ...
  showAnswer: boolean;
  selectedMultiChoice?: boolean;
  selectedMultiSelect?: boolean;
}
...
export const Checkbox = ({
  ...
  return (
    <div className="os-raise-flex os-raise-align-items-center">
      {(selectedMultiChoice || selectedMultiSelect) && correct && showAnswer ? (
        <svg
      ...
      {(selectedMultiChoice || selectedMultiSelect) &&
      !correct &&
      showAnswer ? (
        <svg
          xmlns="http://www.w3.org/2000/svg"
      ...
      <label className="form-check-label os-raise-fill-label-container">
        <Field
          className={`os-form-check-input ${
            ...
            type === "checkbox" && selectedMultiSelect && showAnswer
