...
// Test passes, but need to clean up the \n and strong tags for testing purposes.
// Will need to update the url
describe('search', () => {
  it('fetches and displays search results from API', async () => {
    global.fetch = jest.fn().mockResolvedValue({
      ok: true,
      json: async () => await Promise.resolve(mockQueryResults)
    })
