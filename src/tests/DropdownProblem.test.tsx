...
test('returns the correct className string', () => {
  ...
  expect(className).toEqual('os-form-select mb-3 os-form-select-selected-answer-choice os-form-select-correct-answer-choice os-disabled')

  solution = 'B'

  className = buildClassName(response, solution, formDisabled)

  expect(className).toEqual('os-form-select mb-3 os-form-select-selected-answer-choice os-form-select-wrong-answer-choice os-disabled')
})
